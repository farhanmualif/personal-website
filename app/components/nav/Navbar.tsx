  ...
  return (
    <>
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto lg:px-6 sm:px-6 py-1 md:py-4">
          <div className="flex items-center justify-between md:justify-start">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                type="button"
                className="hidden md:block w-10 h-10 rounded-lg bg-gray-100 border border-gray-200 justify-center items-center">
                <Image
